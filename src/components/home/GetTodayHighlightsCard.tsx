import { ForecastTideDay, Tide, Weather } from "@/types/types";
import {
  Card,
  CardHeader,
  CardContent,
...
import wave from "@/assets/icons/Waves.png";
...
export default function GetTodayHighlightsCard() {
  // const { weatherData: currentData, tideData } = useLoaderData() as {
  //   weatherData: Weather;
  //   tideData: any;
  // };

  const { weatherData: currentData, tideData} = useAtomValue(weatherData);

  const tideTimesWithUnits =
    tideData.forecast.forecastday[0].day.tides[0].tide.map((item: Tide) => {
  ...
  return (
    <Card className="flex-1 w-3/4 min-w-[75%-12px] rounded-lg">
      <CardHeader>
      ...
      <CardContent className="flex flex-col gap-5">
        <div className="flex items-center gap-5">
          <Card className="w-full bg-neutral-100">
            ...
            <CardContent className="w-full flex items-center justify-between">
              <img src={wave} alt="" className="h-14" />
        ...
        <div className="w-full grid grid-cols-4 gap-5">
          ...
          <Card className="w-full h-fit bg-neutral-50">
            ...
            <CardContent className="flex items-center justify-between">
              <img src="src/assets/icons/Fog.svg" alt="" className="h-10 w-10" />
              <p className="poppins-medium scroll-m-20 text-3xl font-semibold tracking-tight">
          ...
          <Card className="w-full h-fit bg-neutral-50">
            ...
            <CardContent className="flex items-center justify-between">
              <img src="src/assets/icons/Hot.svg" alt="" className="h-10 w-10" />
